...
Source0  : https://github.com/dun/munge/archive/munge-0.5.15/munge-0.5.15.tar.gz
...
%prep
%setup -q -n munge-munge-0.5.15
cd %{_builddir}/munge-munge-0.5.15
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699481086
